...
annotate_cell_types <- function(seurat_obj, tissue = "Pancreas", output_dir = getwd()) {
...
detect_malignancy <- function(seurat_obj, tissue_type = "Pancreas", output_dir = getwd()) {
...
enhanced_annotation <- function(seurat_obj, tissue = "Pancreas", output_dir = getwd(), min_cells = 10) {
...
seurat_obj <- enhanced_annotation(seurat_obj, tissue = "Pancreas", output_dir = plots_dir) # Change tissue as needed
